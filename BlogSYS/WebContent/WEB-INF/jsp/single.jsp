...
<head>
	...
	<!--single.js -->
	<script src="${pageContext.request.contextPath}/js/single.js"></script>
	<!--path -->
...
<body class="single">
	...
	<div id="page">
		<div id="fh5co-aside" style="background-image: url(${pageContext.request.contextPath}/images/image_2.jpg)" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<nav role="navigation">
				<ul>
					<li><a href="#" onclick="toIndex()"><i class="icon-home"></i></a></li>
				</ul>
			</nav>
			<div class="page-title">
				<img src="${pageContext.request.contextPath}/images/person_1.jpg" alt="Free HTML5 by FreeHTMl5.co">
	...
	<div class="fh5co-navigation">
		...
		<div class="fh5co-cover next fh5co-cover-sm" style="background-image: url(${pageContext.request.contextPath}/images/project-5.jpg)">
			<div class="overlay"></div>
			<a class="copy" href="#" onclick="">
				<div class="display-t">
					<div class="display-tc">
	...
	<footer>
		<div>
					&copy; 2017 Free HTML5. All Rights Reserved. Designed by <a href="" target="_blank">FreeHTML5</a> 
					</div>
				</footer>
